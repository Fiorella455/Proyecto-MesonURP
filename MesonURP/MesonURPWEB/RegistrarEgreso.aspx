						...
						<h3 class="title1"></h3>
							<div class="form-three widget-shadow">
								<div class="form-horizontal" runat="server">
									...
									<div class="col-sm-8">                                            
                                            <asp:DropDownList id="selectInsumo1" runat="server" CssClass="form-control1">
								    ...
								    <p class="center-button">
						    		    <button type="button" name="sub-1" class="btn btn-primary" runat="server" id="btnEgresar">Egresar</button>
